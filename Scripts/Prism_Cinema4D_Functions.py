...
class Prism_Cinema4D_Functions(object):
	...
	#		if obj.objectName() == 'Cinema4DWindow':
	#			QtParent = obj
	#			break
	#	else:
	#		return False
	...
	def autosaveEnabled(self, origin):
		print('running c4d funtions autosaveEnabled')
	...
	def onProjectChanged(self, origin):
		print('running c4d funtions onProjectChanged')
		pass
